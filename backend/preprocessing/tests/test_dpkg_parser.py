...
Integration test for the Dpkg log preprocessing pipeline.
"""
...
def main():
    ...
    print("=" * 70)
    print("DPKG PREPROCESSING PIPELINE TEST")
    print("=" * 70)
    ...
    info, records = pipeline.process_with_metadata(DPKG_LOG)
    ...
    print("\n" + "=" * 70)
    print("DPKG PIPELINE TEST PASSED")
    print("=" * 70)
